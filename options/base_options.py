...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='give_me_a_name!', help='name of the experiment. It decides where to store samples and models')        
        ...
        self.parser.add_argument('--input_mask_fill', '--fill', dest='fill', type=str, default='W', help='fill to use in the input images for the artificialiy created masks, \
                                  options: "B&W" (salt&peper - default) | "W" (white) | "B" (black) | "G" (grey)')
      
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='/media/dataserver/workspace/blanca/training_datasets/classifier/training')
        self.parser.add_argument('--dataset_list', action='store', type=str, nargs='*', required=True) 
